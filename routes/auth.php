...
Route::middleware('guest')->group(function () {
    ...
    Route::post('register/first-step', [RegisteredUserController::class, 'firstStep'])
    ...
    Route::get('check-email', [PasswordResetLinkController::class, 'check'])
                ->name('password.check');
    ...
    Route::get('reset-success', [NewPasswordController::class, 'resetSuccess'])
                ->name('password.resetSuccess');
});
