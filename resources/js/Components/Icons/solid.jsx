    ...
    setup() {
        return () => (
            <svg xmlns="http://www.w3.org/2000/svg" width="37" height="37" viewBox="0 0 37 37" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M29.7038 29.5112C28.1798 24.6917 24.0848 21.9302 18.4643 21.9302H18.4238C12.7883 21.8987 8.67226 24.6797 7.14526 29.5112L6.96826 30.0722L7.46926 30.3782C10.4063 32.1692 14.0693 33.0767 18.3533 33.0767C18.4013 33.0767 18.4493 33.0767 18.4958 33.0767C22.8398 33.0767 26.4008 32.1932 29.3798 30.3782L29.8808 30.0722L29.7038 29.5112Z" fill="white"/>
                <path fill-rule="evenodd" clip-rule="evenodd" d="M18.4245 18.588C22.509 18.588 25.833 15.2655 25.833 11.181C25.833 7.09496 22.509 3.77246 18.4245 3.77246C14.34 3.77246 11.0175 7.09496 11.0175 11.181C11.0175 15.2655 14.34 18.588 18.4245 18.588Z" fill="white"/>
            </svg>
        )
    },
})
